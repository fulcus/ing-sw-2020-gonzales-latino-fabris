...
public class TurnHandlerVitto {
    private final Game game;
    private VittoServerView currentClient;
    ...
    public TurnHandlerVitto(Game game, GameController gameController) {
        this.game = game;
        currentPlayer = null;
    ...
    private void challengerChooseGods() {
        ...
        for (Player player : players)
            player.getClient().printAllGods(godsDeck);   //getClient() fa la return della serverView corretta
                                                        // printallgods manda messaggio serializable al client per stampare gli dei

        VittoServerView challengerClient = game.getChallenger().getVittoClient();
